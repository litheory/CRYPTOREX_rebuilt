...
def idarun(filename, tmpname):
  ...
  print(config.ida_path + "/idaq -B " + filename)
  os.system(config.ida_path + "/idaq -B " + filename)
	#print(config.ida_path + "/idaq -S " + config.script_path + "\" " + tmpname + "\\" + idbfilename)
  print(config.ida_path + "/idaq -S\"" + config.script_path + "\" " + idbfilename)
  ...
  #os.system(config.ida_path + "/idaq -S\"" + config.script_path + "\" " + tmpname + "\\" + idbfilename)
